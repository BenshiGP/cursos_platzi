...
FILTER
La función filter(), devuelve un valor que esta siendo 
iterado de la cual su resultado será el valor que se esta buscando en el filter
...
Tenemos una lista de estudiantes de la cual debemos saber 
quienes son de Colombia y quienes son considerados mayores 
de edad al tener igual o mas de 18 años y cuantos son.
...
Ahora planteamos el primer problema a resolver, cuales son los 
estudiantes de Colombia y cuantos son:
...
3
Con esto podemos saber que hay 3 estudiantes que son considerados mayores
de edad al tener 18 años o más quienes serían: Pedro con 18 años, carlos,
con 31 años y Ana Maria con 25 años.
...
#crea una nueva lista y no modifica la original             
print(new_numbers)
print(numbers)